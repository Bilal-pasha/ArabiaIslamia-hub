  ...
  return (
    <div className="flex min-h-screen w-full min-w-0 items-center justify-center overflow-x-hidden bg-gradient-to-br from-slate-800 via-[#1a3254] to-[#256089] px-4 py-6 sm:p-6">
      <div className="w-full min-w-0 max-w-md">
        <Card className="w-full border border-white/10 bg-[#0f2744]/95 backdrop-blur-xl">
          <CardContent className="px-4 pb-6 pt-6 sm:px-6 sm:pb-8 sm:pt-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <Label htmlFor="email" className="mb-1.5 block text-slate-200">
                  Email
                </Label>
                <Input
                  id="email"
                  ...
                  className="h-10 border-white/20 bg-white/5 text-white placeholder:text-slate-500"
                  required
                />
              </div>
              <div>
                <Label htmlFor="password" className="mb-1.5 block text-slate-200">
                  Password
                </Label>
                <Input
                  id="password"
            ...
            <p className="mt-4 text-center">
              <Link
                ...
                className="text-sm text-amber-300 hover:underline hover:text-amber-200"
              >
                ← Back to website
              </Link>
            </p>
      ...
      <div className="w-full min-w-0 max-w-md">
        <Card className="w-full border border-white/10 bg-[#0f2744]/95 backdrop-blur-xl">
          <CardContent className="px-4 pb-6 pt-6 sm:px-6 sm:pb-8 sm:pt-8">
            ...
            <Skeleton className="mx-auto mb-2 h-7 w-3/4 bg-white/10" />
            <Skeleton className="mx-auto mb-6 h-4 w-1/2 bg-white/10" />
