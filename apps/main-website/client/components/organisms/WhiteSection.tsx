...
export function WhiteSection() {
  return (
    <section className="bg-pattern-lite bg-[#fffcfc] px-4 py-10 text-foreground sm:px-6 sm:py-12 md:px-8 lg:px-32 lg:py-20">
      <motion.div
        className="mx-auto max-w-4xl space-y-6 text-center sm:space-y-8 lg:space-y-12"
